...
- **circuit-breaker** (this plugin): Blocks calls after consecutive _failures_. Catches genuinely broken tool paths (expired auth, downed services). Transient errors are allowlisted.
